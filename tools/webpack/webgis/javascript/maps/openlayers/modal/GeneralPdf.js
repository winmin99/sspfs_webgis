...
function onClickGeneralOverlay(event) {
  ...
  modalContent.innerHTML = `<div class="navbar-nav">
        <div class="nav-item text-nowrap" id="pdfmodal">
          <a href="pdfjs-4.0.189-dist/web/viewer.html?file=general/${newFeature}">크게보기</a>
          <br>
          <iframe src="pdfjs-4.0.189-dist/web/viewer.html?file=general/${newFeature}" style="width:100%; height:500px; border:1px solid black;"></iframe>
        </div>
      </div>
  ...
  document.getElementById('pdfmodal3').addEventListener('click', openModal);
  modalContainer.addEventListener('click', closeModal);
  document.getElementById('closeModal').addEventListener('click', closeModal);
}

export { onClickGeneralOverlay };
