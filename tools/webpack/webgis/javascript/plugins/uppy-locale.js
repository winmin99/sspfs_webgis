...
ko_KR.strings = {
  ...
  dropPasteFiles: '여기에 파일을 이동시키거나, %{browseFiles}',
  ...
  inferiorSize: '크기가 0 인 파일은 업로드할 수 없습니다.',
  loading: '불러오는 중...',
  logOut: '로그아웃',
  myDevice: '내 기기',
  noDuplicates: '\'%{fileName}\' 이름의 파일이 이미 있습니다',
